      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-lg">
            <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-primary-500/30">
              <Code2 className="w-10 h-10 text-white" />
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-white via-primary-200 to-primary-400 bg-clip-text text-transparent mb-4">
              AI Code Forge
            </h2>
            <p className="text-dark-400 text-sm sm:text-base mb-8">
              Generate production-ready API code with AI. Sign in to start building.
            </p>

            <button
              onClick={() => signIn("google")}
              className="inline-flex items-center gap-3 px-6 py-3 bg-white text-gray-800 font-semibold rounded-xl hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl"
            >
            ...
            <div className="grid grid-cols-3 gap-4 mt-12">
              <div className="p-4 bg-dark-800/50 border border-dark-700/50 rounded-xl">
                ...
                <p className="text-xs text-dark-400">AI-Powered Generation</p>
              </div>
              <div className="p-4 bg-dark-800/50 border border-dark-700/50 rounded-xl">
                <FlaskConical className="w-5 h-5 text-green-400 mx-auto mb-2" />
                <p className="text-xs text-dark-400">Auto Testing</p>
              </div>
              <div className="p-4 bg-dark-800/50 border border-dark-700/50 rounded-xl">
                <Shield className="w-5 h-5 text-orange-400 mx-auto mb-2" />
                <p className="text-xs text-dark-400">Self-Healing Code</p>
              </div>
            </div>
          </div>
        </main>
        <footer className="border-t border-dark-800/50 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            <p className="text-xs text-dark-500">AI Code Forge - Intelligent API Generator</p>
            <p className="text-xs text-dark-600">Powered by Google Gemini</p>
          </div>
        </footer>
      </div>
    );
